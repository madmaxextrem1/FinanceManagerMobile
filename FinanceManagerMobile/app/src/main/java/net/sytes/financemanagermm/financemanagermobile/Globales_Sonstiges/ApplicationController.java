...
public class ApplicationController extends Application {
    ...
    public void resetAllVariableInitializations() {
        Konten.resetInitialize();
        Daueraufträge.resetInitialize();
        Buchungskategorien.resetInitialize();
        Kooperationen.resetInitialize();
        KooperationAnfragen.resetInitialize();
    }
}