...
public class Verwaltung_Konten_Übersicht extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnKontoHinzufügen.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View view) {
                ...
                Verwaltung_Konten_Detailansicht dialog = new Verwaltung_Konten_Detailansicht(Verwaltung_Konten_Übersicht.this, null, new FinanceManagerData_Edited_Interface<Konto>() {
                    @Override
                        ...
                        if(created) {
                            Globale_Funktionen.SQL_createNewKonto(data, new FinanceManagerData_Edited_Interface<Konto>() {
                                ...
                                public void onDataEdited(Konto data, boolean created) {
                                    ...
                                    adapter.notifyDataSetChanged();
                                    Toasty.success(Verwaltung_Konten_Übersicht.this, "Konto angelegt", Toast.LENGTH_SHORT, true).show();
                                }
                            });
                        }
                    }
