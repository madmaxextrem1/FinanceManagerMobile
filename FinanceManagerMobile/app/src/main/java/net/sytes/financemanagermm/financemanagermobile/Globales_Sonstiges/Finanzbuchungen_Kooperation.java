...
public class Finanzbuchungen_Kooperation {
    ...
    public static void initializeFinanzbuchungen(FinanzbuchungenCallback callback, Kooperation kooperation) {
        buchungen = new ArrayList<>();

        SQL_Finanzbuchungen_Filter.setFilterDataKooperationUserId(GlobaleVariablen.getInstance().getUserId(), kooperation.getIdentifier(), SQL_Finanzbuchungen_Filter.UserAndKooperationFilterTyp.KOOPERATION);

        HashMap<String, String> postData = new HashMap<String, String>();
        postData.put("userid", String.valueOf(GlobaleVariablen.getInstance().getUserId()));
        postData.put("OptionalFilter", SQL_Finanzbuchungen_Filter.getFilterString());
        postData.put("DatumVon", SQL_Finanzbuchungen_Filter.getZeitraumVonSQLFormat());
        postData.put("DatumBis", SQL_Finanzbuchungen_Filter.getZeitraumBisSQLFormat());
