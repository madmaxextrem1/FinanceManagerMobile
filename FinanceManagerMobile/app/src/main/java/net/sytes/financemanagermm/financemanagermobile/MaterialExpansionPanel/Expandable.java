...
public class Expandable extends FrameLayout {
    ...
    private void buildView() {
        ...
        expandableViewParams = (LayoutParams) expandableView.getLayoutParams();
    ...
    private void buildHeader() {
        ...
        LayoutParams headerViewParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, collapsedViewHeight);
